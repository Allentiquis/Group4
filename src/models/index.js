 ...
 * This file initializes Sequelize,
 * connects to the database, and automatically
...
const config = require(path.join(__dirname, "/../config/database.js"))[env]; // Load DB config based on environment
